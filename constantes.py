...
CARPETA_RECURSOS ="/home/martin/Documentos/programacion_1/Juego memotest - alumnes/recursos/" #"recursos/" # Carpeta donde se encuentran los recursos
...
SONIDO_OUCH = utils.generar_sonido("{0}{1}".format(CARPETA_RECURSOS,"ouch.mp3"), 0.1)
